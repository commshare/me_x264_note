...
//´Ë½á¹¹ÌåÊÇ¼ÇÂ¼Ò»Ð©Óë±àÂë¹ØÏµ½ÏÐ¡µÄÉèÖÃÐÅÏ¢µÄopt=option
//½á¹¹ÌåÄÚ²¿µÄ±äÁ¿¶¼¿ÉÒÔÍ¨¹ý¶ÁÈ¡main()µÄ²ÎÊý»ñµÃ¡£Ò²¾ÍÊÇargv¡£
typedef struct {
    int b_progress;
    int i_seek;
    hnd_t hin;
...
/* logging and printing for within the cli system   Õâ¸öcliÊÇÃüÁîÐÐÏµÍ³Ã´å*/
